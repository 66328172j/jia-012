...
-- 防治作业单种子（效果评估验收依赖：id=1 已用完=作业完结可评估 / id=2 喷施中未完结不可评估）
INSERT INTO t_pest_spray (id, spray_no, forecast_id, forecast_no, pesticide_name, dose_volume, spray_volume, remain_volume, prepare_by, spray_status, del_flag, create_by, create_time)
VALUES (1, 'SP-0001', 1, 'FC-0001', '吡虫啉', 200, 200, 0, '王防治', 1, 0, 'sys', NOW()),
       (2, 'SP-0002', 1, 'FC-0001', '阿维菌素', 100, 40, 60, '王防治', 0, 0, 'sys', NOW());
...
-- 防治效果评估单
INSERT INTO `t_sys_permission` VALUES (7100100000000001030, '效果评估', '防治效果评估展示', '/PestEffectController/view', 0, 7100100000000001000, 'pest:pestEffect:view', 1, 'layui-icon layui-icon-survey', 3, 0, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission` VALUES (7100100000000001031, '评估单集合', '评估单集合', '/PestEffectController/list', 0, 7100100000000001030, 'pest:pestEffect:list', 2, '', NULL, 0, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission` VALUES (7100100000000001032, '评估单添加', '评估单添加', '/PestEffectController/add', 0, 7100100000000001030, 'pest:pestEffect:add', 2, 'layui-icon layui-icon-add-1', NULL, 0, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission` VALUES (7100100000000001033, '评估单修改', '评估单修改', '/PestEffectController/edit', 0, 7100100000000001030, 'pest:pestEffect:edit', 2, 'layui-icon layui-icon-edit', NULL, 0, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission` VALUES (7100100000000001034, '评估单评估', '评估单评估', '/PestEffectController/evaluate', 0, 7100100000000001030, 'pest:pestEffect:evaluate', 2, 'layui-icon layui-icon-ok-circle', NULL, 0, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission` VALUES (7100100000000001035, '评估单归档', '评估单归档', '/PestEffectController/archive', 0, 7100100000000001030, 'pest:pestEffect:archive', 2, 'layui-icon layui-icon-file', NULL, 0, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission` VALUES (7100100000000001036, '评估单删除', '评估单删除', '/PestEffectController/remove', 0, 7100100000000001030, 'pest:pestEffect:remove', 2, 'layui-icon layui-icon-delete', NULL, 0, 'admin', NOW(), NULL, NULL, NULL);
...
INSERT INTO `t_sys_permission_role` VALUES (7100100000000001130, 488243256161730560, 7100100000000001030, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission_role` VALUES (7100100000000001131, 488243256161730560, 7100100000000001031, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission_role` VALUES (7100100000000001132, 488243256161730560, 7100100000000001032, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission_role` VALUES (7100100000000001133, 488243256161730560, 7100100000000001033, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission_role` VALUES (7100100000000001134, 488243256161730560, 7100100000000001034, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission_role` VALUES (7100100000000001135, 488243256161730560, 7100100000000001035, 'admin', NOW(), NULL, NULL, NULL);
INSERT INTO `t_sys_permission_role` VALUES (7100100000000001136, 488243256161730560, 7100100000000001036, 'admin', NOW(), NULL, NULL, NULL);
